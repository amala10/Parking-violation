...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etEmail = (EditText) findViewById(R.id.emailRegistration);
        etPassword = (EditText) findViewById(R.id.passwordRegistration);
    ...
    public void openLogin (View arg0){
    ...
    public void submitRegistrationDetails(View arg0) {
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("https://anurous-combustion.000webhostapp.com/Signup.inc.php");
